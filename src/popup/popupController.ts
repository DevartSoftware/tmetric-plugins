class PopupController {
    ...
    getData(accountId: number) {
        ...
        this.initializeAction({ accountId, includeRecentTasks: !this.isPagePopup }).then(data => {
            this.setData(data);
    ...
    setData(data: IPopupInitData) {
        if (data.timer) {
            ...
            this._newIssue = JSON.parse(JSON.stringify(data.newIssue));
            this._newIssueInitial = JSON.parse(JSON.stringify(data.newIssue));
