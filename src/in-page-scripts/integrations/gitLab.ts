class GitLab implements WebToolIntegration {
    ...
    matchUrl = [
        '*://*/work_items/*',
        '*://*/work_items?show=*',
        '*://*/issues/*', // version with issue url
        '*://*/issues?show=*', // version with issue url
        '*://*/merge_requests/*'
    ];
    ...
    getIssue(_issueElement: HTMLElement, source: Source) {
        ...
        // https://gitlab.com/NAMESPACE/PROJECT/work_items/incident/NUMBER
        // https://gitlab.com/NAMESPACE/PROJECT/merge_requests/NUMBER
        const regExp = /^(.+)\/(work_items|work_items\/incident|merge_requests|issues|issues\/incident)\/(\d+)$/;
        ...
        if (!match) {
            issueLink = $$<HTMLAnchorElement>('a[data-testid="work-item-drawer-ref-link"]', _issueElement)?.href
                || $$<HTMLAnchorElement>('a[data-testid="work-item-detail-panel-ref-link"]')?.href
            if (issueLink != null) {
        ...
        if (issueType == 'work_items/incident' || issueType == 'issues/incident') {
